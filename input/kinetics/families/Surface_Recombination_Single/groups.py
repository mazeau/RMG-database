...
name = "Surface_Recombination_Single/groups"
shortDesc = u""
longDesc = u"""
Surface addition where two single bonds combine to make a double bonded species.
...
reverse = "Surface_Bond_Fission_Single"
